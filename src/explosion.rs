use bevy::{color::palettes::css::{GREEN, RED}, pbr::{ExtendedMaterial, MaterialExtension}, prelude::*, render::render_resource::{AsBindGroup, ShaderRef}};
...
impl Plugin for ExplosionPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins((MaterialPlugin::<
            ExtendedMaterial<StandardMaterial, ExplosionMaterialExtension>,
        >::default(),))
